...
## Project Structure
    ...
    ├── real_estate_rental__38027  # Django project configurations
...
1. Clone this repo and `cd real_estate_rental__38027`
...
2. Clone this repo and `cd real_estate_rental__38027`
